...
def create_app():
    ...
    def is_safe_url_path(target):
        ...
        return parts.scheme == '' and parts.netloc == "" and parts.path.startswith("/")
        ...
        if request.method == 'POST':
            ...
            if not errors:
                ...
                if user and user.check_password(password):
                    ...
                    next_url= urlparse(request.form.get("next") or request.args.get('next') or '').path
                    print(next_url)
                    if is_safe_url_path(next_url):
